        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              We care about your privacy and want to be transparent about how we handle your data.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto glass-card p-8 md:p-12">
            <div className="prose prose-invert max-w-none">
              <h2 className="text-2xl font-bold text-flick-white mb-6">
                Privacy Policy for flick2split
              </h2>
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Interpretation and Definitions</h3>
              
              <h4 className="text-lg font-semibold text-flick-white mt-6 mb-3">Interpretation</h4>
              <p className="text-white/80 mb-4">
                The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
              </p>
              
              <h4 className="text-lg font-semibold text-flick-white mt-6 mb-3">Definitions</h4>
              <p className="text-white/80 mb-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-white/80 mb-6">
                ...
                <li><strong>Application</strong> refers to flick2split, the software program provided by the Company.</li>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to flick2split.</li>
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Collecting and Using Your Personal Data</h3>
              
              <h4 className="text-lg font-semibold text-flick-white mt-6 mb-3">Types of Data Collected</h4>
              
              <h5 className="text-base font-semibold text-flick-white mt-4 mb-2">Personal Data</h5>
              <p className="text-white/80 mb-4">
                While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
              </p>
              <p className="text-white/80 mb-4">Usage Data</p>
              
              <h5 className="text-base font-semibold text-flick-white mt-4 mb-2">Usage Data</h5>
              <p className="text-white/80 mb-4">
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Retention of Your Personal Data</h3>
              <p className="text-white/80 mb-4">
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Transfer of Your Personal Data</h3>
              <p className="text-white/80 mb-4">
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Delete Your Personal Data</h3>
              <p className="text-white/80 mb-4">
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Disclosure of Your Personal Data</h3>
              
              <h4 className="text-lg font-semibold text-flick-white mt-6 mb-3">Business Transactions</h4>
              <p className="text-white/80 mb-6">
                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
              </p>
              
              <h4 className="text-lg font-semibold text-flick-white mt-6 mb-3">Law enforcement</h4>
              <p className="text-white/80 mb-6">
                Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
              </p>
              
              <h4 className="text-lg font-semibold text-flick-white mt-6 mb-3">Other legal requirements</h4>
              <p className="text-white/80 mb-4">
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Security of Your Personal Data</h3>
              <p className="text-white/80 mb-6">
                The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
              </p>
              
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Children's Privacy</h3>
              <p className="text-white/80 mb-4">
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Links to Other Websites</h3>
              <p className="text-white/80 mb-6">
              ...
              <h3 className="text-xl font-semibold text-flick-white mt-8 mb-4">Changes to this Privacy Policy</h3>
              <p className="text-white/80 mb-4">
